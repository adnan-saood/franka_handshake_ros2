...
# urdf_file: URDF file path relative to franka_handshake_description/robots (default: 'fr3/fr3.urdf.xacro')
...
# Example:
# ros2 launch franka_handshake_bringup franka.launch.py arm_id:=fr3 namespace:=NS1 robot_ip:=172.16.0.3

# This is an error prone commandline, you may prefer to write the parameters into a YAML file like:
#   franka_handshake_bringup/config/franka.config.yaml
...
# franka_handshake_description/robots to avoid runtime errors.
#
...
def generate_robot_nodes(context):
    ...
    urdf_path = PathJoinSubstitution([
        FindPackageShare('franka_handshake_description'), 'urdf', LaunchConfiguration('urdf_file')
    ]).perform(context)
